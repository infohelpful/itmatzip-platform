import { TOOLS } from "../assets/tools-registry.js?v=21";
import { DEFAULT_SITE_CONFIG, mergeSiteConfig, SITE_LANGS } from "../common/site-config.js?v=7";
